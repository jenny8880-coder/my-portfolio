...
// Navigation header
function Frame28({ name, switchVibeLabel, onSwitchVibe }: { name: string; switchVibeLabel: string; onSwitchVibe: () => void }) {
  return (
          ...
          <div className="flex flex-col items-center size-full">
            <div className="content-stretch flex flex-col gap-[112px] items-center px-[128px] py-0 relative w-full">
              ...
              <motion.div 
                ...
                transition={{ duration: 0.6, ease: "easeOut" }}
              >
                <Frame28 name={data.hero.name} switchVibeLabel={data.navigation.switchVibeButton.label} onSwitchVibe={onSwitchVibe} />
